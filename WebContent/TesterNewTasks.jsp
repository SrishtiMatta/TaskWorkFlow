 ...
 .back{
	...
	<script>
		function ConfirmAssign(){
			var r = confirm("Are you sure you want to take up this task for testing");
			if(r==true){
				return true; 
			}
			else
	...
	<% 	if(session.getAttribute("USER_DETAILS")==null){
			...
			<%	Connection connection = null;
		        ...
		        PreparedStatement ps=(PreparedStatement) connection.prepareStatement("select * from tasks where Status=?");
	       ...
	       <TABLE BORDER="1">
	    		...
	    		%>
	           		<TR>
		                ...
		                <TD><a href="TestTask?TaskID=<%=resultset.getString(1) %>&TaskName=<%= resultset.getString(2)%>&UserId=<%= resultset.getString(4)%>"  onClick ="return ConfirmAssign();" >Test</a></TD>
		            </TR>
				<% 
